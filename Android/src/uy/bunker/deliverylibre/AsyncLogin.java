...
public class AsyncLogin extends AsyncTask<String, String, JSONObject>{
	...
	//String code = context.getString(R.string.code_url);
	...
	protected void onPostExecute(JSONObject json) {
		...
		if(!logueado){
			if (checkCode) {
				...
				String urlLogueado = "http://deliverylibre.herokuapp.com/addUser";
